...
const blocks = [
  {
    ...
    subblocks: [
      <span key={"summary_1"}> 
        ...
        возможностью ручной корректировки найденных текстовых маркёров. Далее, используя найденные данные, 
  ...
  },
  {
    ...
    subblocks: [
      ...
      {align: "right", content: "Автоматическая система предоставит таблицу текстовых маркеров, найденных методом анализирования текста"},
